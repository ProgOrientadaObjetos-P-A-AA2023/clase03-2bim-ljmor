...
public abstract class Estudiante {
    ...
    public Estudiante(String nEst, String apeESt, String idEst, int edEst) {
        nombresEstudiante = nEst;
        apellidosEstudiante = apeESt;
        identificacionEstudiante = idEst;
        edadEstudiante = edEst;
    }
